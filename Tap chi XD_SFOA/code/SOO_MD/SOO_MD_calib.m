%% SOO_MD_calib.m
% NOT a paper-data driver. Hardware-calibration fork of SOO_MD_run.m: runs
...
% (seconds/FE) for the MD structure on this machine. Do not use its
% .mat/.log output as paper data -- see SOO_MD_run.m for the real driver.
%
...
logFile = fullfile(outDir, sprintf('MD_%s_CALIB_progress.log', objName)); % separate from the real progress log
