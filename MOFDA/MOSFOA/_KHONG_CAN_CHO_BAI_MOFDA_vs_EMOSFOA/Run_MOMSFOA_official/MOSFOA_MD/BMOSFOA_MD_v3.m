...
fprintf('[B-MOSFOA MD] Run mode: %s; Npop=%d; Max_it=%d; expected FEs=%d.\n', ...
...
ParallelConfig = struct( ...
    ...
    'PopulationSize', Npop);
fprintf('[B-MOSFOA MD] Using %d SAP2000 instances (%.0f%% of %d max logical workers; physical cores: %d).\n', ...
...
Name_res = sprintf('MD_BMOSFOA_%s_%s_WF%03d_Npop%d_Nvar%d_Maxit%d.mat', ...
