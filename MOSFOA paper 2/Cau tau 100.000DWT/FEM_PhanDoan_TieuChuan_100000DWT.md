...
**✅ ĐÃ XÁC MINH ĐỦ 15/15 LỚP (thay thế hoàn toàn bảng cũ trích từ DXF bên dưới — bảng cũ bị LỆCH NHÃN, xem cảnh báo cuối mục).**

**Nguồn:** Trích trực tiếp từ ảnh gốc **"Bảng 1: Bảng tổng hợp chỉ tiêu cơ lý các lớp đất"** (Thuyết minh kỹ thuật gói XL01, trang 13–14, Công ty CP Tư vấn XDCT Hàng hải) — đây là bảng nhúng dạng ảnh trong file `Thuyet minh 06.12.doc`, đã trích xuất bằng cách export toàn bộ .doc sang PDF (Word COM) rồi render trang bằng PyMuPDF (không dùng OCR/suy diễn). **Ảnh gốc lưu tại:** [`Dia_chat_LachHuyen_BangGoc/Bang1_ChiTieuCoLy_trang1-2.png`](Dia_chat_LachHuyen_BangGoc/Bang1_ChiTieuCoLy_trang1-2.png) và [`...trang2-2.png`](Dia_chat_LachHuyen_BangGoc/Bang1_ChiTieuCoLy_trang2-2.png) — **dùng 2 ảnh này để đối chiếu lại trước khi tính toán chính thức**, bảng dưới đây chỉ trích các chỉ tiêu cốt lõi phục vụ tính sức chịu tải cọc (bỏ qua các chỉ tiêu phụ: thành phần hạt chi tiết, nén 3 trục UU/CU, cố kết Cv/Cc/σ, hệ số thấm K — xem đầy đủ trong ảnh gốc).

| Lớp | W (%) | γw (g/cm³) | Δ (g/cm³) | e₀ | φ | C (kG/cm²) | Ghi chú |
|---|---|---|---|---|---|---|---|
| 1a | — | — | 2,66 | — | — | — | Cát hạt bụi, rời rạc — đặc trưng bằng góc nghỉ αk=33°05'/αư=24°19', γch=1,461/γr=1,170 |
| 1 | — | — | 2,66 | — | — | — | Cát hạt trung, rời rạc — αk=30°37'/αư=25°55', γch=1,485/γr=1,209 |
| 2 | 50,7 | 1,71 | 2,68 | 1,362 | 5°53' | 0,069 | Sét, dẻo chảy |
| 3 | 28,2 | 1,94 | 2,68 | 0,771 | 7°03' | 0,107 | Sét pha, dẻo chảy |
| 4 | — | — | 2,66 | — | — | — | Cát bụi, chặt vừa — αk=33°20', γch=1,513/γr=1,196 |
| 5 | 25,0 | 1,99 | 2,67 | 0,677 | 10°16' | 0,082 | Cát pha, trạng thái chảy |
| TK1 | 42,7 | 1,76 | 2,70 | 1,189 | 7°27' | 0,100 | Sét, dẻo chảy |
| 6 | 22,0 | 2,01 | 2,67 | 0,621 | 10°46' | 0,107 | Cát pha, dẻo |
| 7 | 26,6 | 1,96 | 2,69 | 0,738 | 9°59' | 0,136 | Sét pha, dẻo mềm |
| 8 | 27,8 | 1,94 | 2,70 | 0,779 | 13°21' | 0,225 | Sét, dẻo cứng |
| 9 | 43,7 | 1,76 | 2,70 | 1,204 | 7°26' | 0,117 | Sét, dẻo chảy |
| TK2 | 12,3 | 2,20 | 2,66 | 0,358 | 19°08' | 0,120 | Cát pha lẫn dăm sạn, cứng |
| 10 | 19,6 | 2,04 | 2,70 | 0,583 | 18°10' | 0,200 | Đá sét kết phong hoá hoàn toàn → sét pha, cứng |
| 11 | 4,16 | 2,51 | 2,74 | 12,65 (độ rỗng n%, không phải e₀) | — | — | Đá, phong hoá mạnh — Rk(khô)=129,0 kG/cm², Rbh(bão hoà)=92,0 kG/cm², hệ số hoá mềm Hm=0,71 |
| 12 | 0,70 | 2,64 | 2,75 | 2,46 (độ rỗng n%) | — | — | Đá gốc, phong hoá nhẹ — Rk(khô)=703,0 kG/cm², Rbh(bão hoà)=631,0 kG/cm², Hm=0,90 |

**⚠️ Cảnh báo quan trọng — bảng trích từ DXF ở phiên bản trước của file này SAI:** Bảng cũ (lấy từ bản vẽ mặt cắt địa chất, ghi "8→γ=2,04...", "10(đá)→γ=2,51...") thực chất đã **lệch nhãn 1-2 hàng** — các giá trị đó thực sự là của **lớp 10** (γw=2,04; e=0,583; φ=18°10'; C=0,200) và **lớp 11** (γw=2,51; Δ=2,74; Rk=129/Rbh=92), không phải lớp 8/10 như ghi trước đó. Đây đúng là điều bảng cũ đã tự cảnh báo ("N=41-50 có thể lệch nhãn, cần đối chiếu") — nay đã xác nhận **đúng là bị lệch**, và đã được sửa bằng bảng chuẩn ở trên lấy trực tiếp từ ảnh gốc Bảng 1.
...
3. ✅ **ĐÃ XỬ LÝ (08/09/2026):** Bảng chỉ tiêu cơ lý đất nền trước đây chỉ đối chiếu chắc chắn 5/12 lớp và có nghi ngờ lệch hàng — nay đã **xác minh đủ 15/15 lớp** bằng cách trích trực tiếp ảnh gốc "Bảng 1" từ `Thuyet minh 06.12.doc` (xem mục 8 ở trên, ảnh gốc lưu tại `Dia_chat_LachHuyen_BangGoc/`). Đã xác nhận bảng cũ trích từ DXF **thực sự bị lệch nhãn** như nghi ngờ (giá trị gán cho lớp 8/10 thực ra là của lớp 10/11) — bảng mới ở mục 8 là bản chuẩn, thay thế hoàn toàn bảng cũ.
